...
export interface PromptEditorProps<
  ...
  IV extends
    | ChatCondenseQuestionPromptTemplateInputValues
    | ChatQuestionAnswerPromptTemplateInputValues
    | ChatRouterPromptTemplateInputValues = PTC extends typeof ChatCondenseQuestionPromptTemplate
    ? ChatCondenseQuestionPromptTemplateInputValues
    : PTC extends typeof ChatQuestionAnswerPromptTemplate
    ? ChatQuestionAnswerPromptTemplateInputValues
    : ChatRouterPromptTemplateInputValues,
> {
  ...
  readonly defaultInputValues: Partial<IV> & Record<string, any>;
}
...
export const PromptEditor: FC<PromptEditorProps> = (props) => {
  ...
  const inputValues: (typeof props)['defaultInputValues'] = props.defaultInputValues || {};
  ...
  return (
    <Grid gridDefinition={[{ colspan: 6 }, { colspan: 6 }]}>
      <Box>
        {showConfig ? (
          <CodeEditor value={JSON.stringify(inputValues, null, 2)} language="json" readonly editorContentHeight={390} />
        ) : (
          <CodeEditor
